...
$pdf->setAuthor('Diah Martiani');
$pdf->setTitle('Laporan Pembayaran Umum');
$pdf->setSubject('Pembayaran Umum');
$pdf->setKeywords('SIP, Pembayaran Umum');
...
$html = '
<p align="center"><strong><bold>Laporan Pembayaran Umum</strong></b></p><br>
...
<table style="width:100%; border-collapse:collapse; border: 1px solid black;" border="1">
    <tr style="font-weight:bold; text-align:center;">
        ...
        <td style="width:20%;">Nomimal Pembayaran</td>
    </tr>
';

$sql="SELECT bayar.*,siswa.nis,siswa.nama,siswa.kelas,bayar_metode.metode FROM bayar,siswa,bayar_metode WHERE bayar.dihapus_pada IS NULL AND bayar.id_siswa=siswa.id_siswa AND bayar.id_bayar_metode=bayar_metode.id_bayar_metode AND bayar.tanggal_bayar BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY bayar.tanggal_bayar ASC";
...
$pdf->Output('laporan_peserta_didik', 'I');
