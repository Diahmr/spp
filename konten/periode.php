            ...
            <div class="card">
              ...
              ?>
                        <tr>
                            ...
                            <td>
                                <!-- Tombol Edit -->
                                <a href="#" data-toggle="modal" data-target="#modalUbah<?=$kolom ['id_periode']; ?>"><i class="fas fa-edit"></i>
                                </a>
                                &nbsp;
                                <!-- Tombol Hapus -->
                                <a
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="aksi/periode.php" method="post">
                                            ...
                                            <input type="text" name="periode" value ="<?= $kolom['periode'];?>" class="form-control" required="required">

                                            <label for="tanggal_awal">Tanggal Awal Periode</label>
                                            <input type="date" name="tanggal_awal" value ="<?= $kolom['tanggal_awal'];?>" class="form-control" required="required">

                                            <label for="tanggal_akhir">Tanggal Akhir Periode</label>
                                            <input
                                                type="date"
                                                name="tanggal_akhir" value ="<?= $kolom['tanggal_akhir'];?>"
                                                class="form-control"
                                                required="required">
              ...
              ?>
                    ...
                    <button
                        ...
                        <i class="fas fa-plus"></i>Tambah Periode Baru</button>
                </div>
            </div>
              ...
              ?>
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;
                            <a
                                onclick="return confirm('Yakin akan menghapus data ini secara permanen?')"
