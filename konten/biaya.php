...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          ?>
                                            <select id="periode" name="id_periode" class="form-control">
                                                <option value="">--Pilih Periode--</option>

                                                <?php while ($kolom2 = mysqli_fetch_array($sql2)) : ?>
                                                <?php if($kolom2['id_periode']==$kolom['id_periode']){ ?>
                                                <option name="periode" value="<?= $kolom2['id_periode'] ?>" selected="selected"><?= $kolom2['periode'] ?></option>
                                            <?php } else { ?>
        ...
        <div class="modal-content">
          ...
          ?>
                    <select id="periode" name="id_periode" class="form-control">
                        ...
                        <?php while ($kolom2 = mysqli_fetch_array($sql2)) : ?>
                        <option name="periode" value="<?= $kolom2['id_periode'] ?>"><?= $kolom2['periode'] ?>
                        </option>
                        <?php endwhile ?>
                    </select>
