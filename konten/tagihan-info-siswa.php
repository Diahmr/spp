            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Detail Tagihan Siswa</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
                        ...
                        <?php 
                            ...
                            while($bayar_alokasi=mysqli_fetch_array($query)){
                                ...
                                <tr>
                                    ...
                                    <td><a href='index.php?p=bayar-alokasi-siswa&id_bayar=$bayar_alokasi[id_bayar]' target='blank' title='Lihat Detail Alokasi'>#$bayar_alokasi[id_bayar]</a> | <a href='file/buktibayar/$bayar_alokasi[bukti]' target='blank' title='Lihat Foto Bukti'><i class='fas fa-image'></a></td>
