    ...
    <section class="content">
        ...
        <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="date" name="tanggal_jatuh_tempo" class="form-control" <?php if($tagihan['total_terbayar']>0){ ?> readonly <?php } ?> value="<?= $tagihan['tanggal_jatuh_tempo']; ?>">
                    <div class="row">
                        <div class="col-md-4">
                        <label for="siswa">Total Tagihan</label>
                        <input type="number" name="jumlah_biaya" class="form-control text-right" <?php if($tagihan['total_terbayar']>0){ ?> readonly <?php } ?> value="<?=$tagihan['jumlah_biaya']; ?>">
                        </div>
                        <div class="col-md-4">
                    ...
                    ?>
                    <div class="alert alert-warning mt-3 text-center text-bold" role="alert">
                        Perhatian!!!<br>
