            ...
            <div class="card">
              ...
              ?>
                        <tr class="<?= $warna; ?>">
                            ...
                            <!-- Tombol Informasi -->
                            <td>
                                <a title="Detail Riwayat Tagihan" href="index.php?p=tagihan-info-siswa&id_tagihan=<?= $kolom['id_tagihan']; ?>"><i class="fas fa-search"></i></a></td>
                        </tr>
            ...
            <div class="card">
              ...
              ?>
                        <tr>
                            ...
                            <td>
                                <a title="Detail Riwayat Pembayaran" href="index.php?p=bayar-alokasi-siswa&id_bayar=<?= $kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a></td>
