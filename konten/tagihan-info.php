                        ...
                        <?php 
                            ...
                            while($bayar_alokasi=mysqli_fetch_array($query)){
                                ...
                                <tr>
                                    ...
                                    <td><a href='index.php?p=bayar-alokasi&id_bayar=$bayar_alokasi[id_bayar]'target='blank' title='Lihat Detail Alokasi'>#$bayar_alokasi[id_bayar]</a> | <a href='file/buktibayar/$bayar_alokasi[bukti]' target='blank' title='Lihat Foto Bukti'><i class='fas fa-image'></a></td>
