...
<head>
  ...
  <title>Login Ke Sistem Informasi Pembayaran (SIP)</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h3"><b>Sistem Informasi Pembayaran</b></a>
    </div>
    <div class="card-body">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item md-6">
        <a class="nav-link md-6" href="#manajemen" data-toggle="tab"> <i class="fas fa-user"></i> Manajemen</a>
        </li>
      </ul>
      ...
      <form action="aksi/siswa.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Masukkan NIS (Nomor Induk Siswa)" name="nis">
